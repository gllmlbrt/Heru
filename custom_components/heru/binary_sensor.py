...
BINARY_SENSOR_DESCRIPTIONS: tuple[HeruBinarySensorDescription, ...] = (
    ...
    HeruBinarySensorDescription(key="fire_alarm", translation_key="fire_alarm", bit_index=9, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="rotor_alarm", translation_key="rotor_alarm", bit_index=10, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="freeze_alarm", translation_key="freeze_alarm", bit_index=12, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="low_supply_alarm", translation_key="low_supply_alarm", bit_index=13, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="low_rotor_temperature_alarm", translation_key="low_rotor_temperature_alarm", bit_index=14, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="temperature_sensor_open_circuit_alarm", translation_key="temperature_sensor_open_circuit_alarm", bit_index=17, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="temperature_sensor_short_circuit_alarm", translation_key="temperature_sensor_short_circuit_alarm", bit_index=18, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="pulser_alarm", translation_key="pulser_alarm", bit_index=19, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="supply_fan_alarm", translation_key="supply_fan_alarm", bit_index=20, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="exhaust_fan_alarm", translation_key="exhaust_fan_alarm", bit_index=21, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="supply_filter_alarm", translation_key="supply_filter_alarm", bit_index=22, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="exhaust_filter_alarm", translation_key="exhaust_filter_alarm", bit_index=23, entity_category=EntityCategory.DIAGNOSTIC),
    HeruBinarySensorDescription(key="filter_timer_alarm", translation_key="filter_timer_alarm", bit_index=24, entity_category=EntityCategory.DIAGNOSTIC),
